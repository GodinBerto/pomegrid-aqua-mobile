    ...
    <Screen contentContainerClassName="justify-center flex-grow py-8">
      <Card className="gap-5">
        ...
        <View className="gap-2">
          ...
          />
          <Button variant="ghost" size="sm" className="self-end px-0" onPress={() => setShowPassword((value) => !value)}>
            <View className="flex-row items-center gap-2">
              {showPassword ? <EyeOff color={palette.primary} size={16} /> : <Eye color={palette.primary} size={16} />}
